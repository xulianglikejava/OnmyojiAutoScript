...
class ConfigMenu:
    ...
    def __init__(self) -> None:
        ...
        # 活动的任务
        # 体验服爬塔与当前爬塔并列展示，使用独立配置和标注资源。
        self.menu["Activity Task"] = ['ActivityShikigami', 'ExperienceClimb', 'MartialTournament', 'MetaDemon', 'FrogBoss', 'FloatParade', 'Quiz', 'KittyShop', 'DyeTrials', 'GuguArtStudio']
        # 开发工具
